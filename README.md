...
Although the initial hypothesis assumed that menstrual period days would reduce study hours due to hormonal and physiological effects, the visualizations did not reveal a clear or consistent downward trend during menstrual phases. Study hour patterns remained relatively stable across cycle days, supporting the statistical finding that menstrual status alone does not significantly influence study duration. Similarly, comparisons based on painkiller usage showed no substantial visual differences, suggesting that increased pain severity did not meaningfully reduce study time in this dataset. In contrast, visual analyses consistently highlighted exam periods as a stronger driver of fluctuations in study behavior, indicating that academic pressure may mask or outweigh menstrual cycle–related effects. Overall, the visual evidence aligns with the extended hypothesis testing results, reinforcing the conclusion that contextual academic factors play a more prominent role in shaping study productivity than menstrual cycle characteristics.
